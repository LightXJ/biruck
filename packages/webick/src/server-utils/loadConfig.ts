...
const loadConfig = (): IConfig => {
  ...
  const clientEntry = join(cwd, './node_modules/@biruck/webick/esm/src/entry/client-entry.js');
  const clientOutput = join(cwd, './dist/client');

  const serverEntry = join(cwd, './node_modules/@biruck/webick/esm/src/entry/server-entry.js');
